...
\ctable[cap={}, caption={Performance metrics for the random forest
  models built for the datasets used in this study. Training RMSE and $R^2$ are
based on out-of-bag data\cite{Breiman:1984aa} and test metrics are based on a separate
hold out set. },
