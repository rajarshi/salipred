...
(4) The selection of training and test sets should be clearly specified in the Methods section. For
...
(5) No support is provided for the assumption that the RF models “are relatively robust even for
...
(6) There is only limited statistical assessment/validation of the models. Statements made in the
