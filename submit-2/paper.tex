...
\pagestyle{empty}
\begin{center}
{\huge For Table of Contents Use Only}
\end{center}
\vskip 10em
\parindent 0pt
\begin{tabular}[t]{|p{3in}|c|}\hline
\raggedright{\textbf{Exploring Uncharted Territories - Predicting Activty Cliffs in
  Structure-Activity Landscapes}} \vskip 1em
\raggedright{Rajarshi Guha${}^{*}$} &
\parbox{3.5in}{\includegraphics[width=3.5in]{toc}}
\\ \hline
